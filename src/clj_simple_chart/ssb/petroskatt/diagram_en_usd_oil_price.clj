...
(def oil-date-to-nok brentoilprice/brent-12-mma-dato-to-usd)
...
(def header (opentype/stack
              ...
              [{:text "Tax revenues from petroleum activities, Norwegian Central Government" :font "Roboto Black" :font-size 27}
               {:text (str "NOK billion, 12 months moving sum, nominal. " siste-verdi-str) :font "Roboto Black" :font-size 16}
               ...
               {:margin-top 16 :text "Oil price, USD/barrel, nominal" :fill oil-fill :font "Roboto Black" :font-size 16}
  ...
  [:g {:transform (translate (- svg-width marg) (- (:height (meta header)) 2))}
   (opentype/text
     {:text        "NOK billion, nominal"
      ...
      :font-size   16})
   (opentype/text
     {:text        "Special income tax on extraction of petroleum"
      :text-anchor "end"
      :fill        saerskatt-fill
      :font        "Roboto Black"
      :dy          "-1em"
      :font-size   16})
   (opentype/text
     {:text        "Ordinary taxes on extraction of petroleum"
      :text-anchor "end"
      :dy          "-0em"
      :fill        ordinaer-fill
      :font        "Roboto Black"
...
(def footer (opentype/text-stack-downwards
              {:margin-left   marg
               :margin-top    8
               :margin-bottom 3}
              [{:text "Sources: Statistics Norway, Norges Bank, St. Louis Fed" :font-size 14}]))
...
(def yy {:type                :linear
         ...
         :tick-values         (mapv #(* 20.0 %) (range 13))
...
(def yy2 {:type               :linear
          :orientation        :left
          :color              oil-fill
          :tick-values        (mapv #(* 10.0 %) (range 13))
          :axis-text-style-fn (fn [x] {:font "Roboto Bold"})
          :domain             [0 120]})
...
(defn render-self []
  (core/render "./img/ssb-svg/petroskatt-mms-en-oil-price-usd.svg" "./img/ssb-png/petroskatt-mms-en-oil-price-usd.png" (diagram)))
