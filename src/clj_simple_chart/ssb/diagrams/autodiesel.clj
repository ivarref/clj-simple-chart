(ns clj-simple-chart.ssb.diagrams.autodiesel
...
(def header (opentype/stack
              ...
              [{:text "Sal av autodiesel" :font "Roboto Bold" :font-size 30}
...
(defn render-self []
  (core/render "img/ssb-svg/autodiesel.svg" "img/ssb-png/autodiesel.png" (diagram)))
