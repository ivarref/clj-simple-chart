(ns clj-simple-chart.ssb.diagrams.autos-noreg
  (:require [clj-simple-chart.ssb.data.petroleum-location :as datasource]
...
(def data (datasource/data "Hele landet"))
...
(def header (opentype/stack
              ...
              [{:text "Sal av bensin og diesel, heile landet" :font "Roboto Bold" :font-size 30}
               {:text "12 månadar glidande sum" :font "Roboto Bold" :font-size 16 :margin-bottom 10}
               {:text "Autodiesel" :fill "red" :font "Roboto Bold" :font-size 16 :valign :bottom :align :right}
               {:text "Bilbensin" :fill "green" :font "Roboto Bold" :font-size 16 :valign :bottom :align :right}
...
(defn render-self []
  (core/render "img/ssb-svg/autos-noreg.svg" "img/ssb-png/autos-noreg.png" (diagram)))
