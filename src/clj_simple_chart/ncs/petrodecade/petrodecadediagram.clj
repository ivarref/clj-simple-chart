(ns clj-simple-chart.ncs.petrodecade.petrodecadediagram
  (:require [clj-simple-chart.core :as core]
            [clj-simple-chart.opentype :as opentype]
            [clj-simple-chart.axis.core :as axis]
            [clj-simple-chart.chart :as chart]
            [clj-simple-chart.ncs.petrodecade.petrodecadedata :as production]
...
(def header (opentype/stack
              ...
              [{:text (str "Petroleumsproduksjon etter funntiår") :font "Roboto Bold" :font-size 30}
               ...
               {:text (str "Produksjon per " (months-str (:date last-data)) ": "
                           ...
                           " mill. Sm³ oljeekvivalentar")
                :font "Roboto Bold" :font-size 16 :margin-top 3}

               {:text "Millionar Sm³ oljeekvivalentar" :font "Roboto Bold" :font-size 16 :valign :bottom :align :right}
  ...
  [:svg {:xmlns "http://www.w3.org/2000/svg" :width svg-width :height svg-height}
   [:g {:transform (translate marg marg)}
    ...
    (let [infotext (opentype/stack #_{:fill         "lightgray"
                     ...
                     {}
                     (flatten
                       [{:text "Funntiår" :font "Roboto Black" :font-size 16}
                        (mapv (fn [k]
                                {:text      (str (subs k 3) "")
                                 :font-size 16
                                 :font      "Roboto Bold"
...
(defn render-self []
  (core/render "./img/ncs-svg/petro-discovery-decade-production.svg" "./img/ncs-png/petro-discovery-decade-production.png" (diagram)))
