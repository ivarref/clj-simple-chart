(ns clj-simple-chart.ncs.discovery.petroleum-resource-class-diagram
...
(def colors {:not-evaluated          hydro-blue
             ...
             :pdo-approved           red              ; hard green
             :remaining-reserves     brown
             :producing-produced     "rgb(200, 146, 135)"
...
(def header (opentype/stack
              ...
              [
               {:text "Gjenverande petroleumsressursar og kumulativ produksjon" :font "Roboto Bold" :font-size 30 :margin-bottom 3}
               {:text (str "Årleg produksjon " datasource/max-complete-year ": "
                           (let [v (production/yearly-production production/field-names datasource/max-complete-year :petroleum)]
...
(defn render-self []
  (core/render "./img/ncs-svg/discovery-overview-petroleum.svg" "./img/ncs-png/discovery-overview-petroleum.png" (diagram)))
