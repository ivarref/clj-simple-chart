(ns clj-simple-chart.ncs.petroprodpp.petroprodppdiagram
  (:require [clj-simple-chart.core :as core]
            [clj-simple-chart.opentype :as opentype]
            [clj-simple-chart.axis.core :as axis]
            [clj-simple-chart.chart :as chart]
            [clj-simple-chart.ncs.petroprodpp.petroprodppdata :as production]
...
(def header (opentype/stack
              ...
              [{:text (str "Petroleumsproduksjon etter feltmogning") :font "Roboto Bold" :font-size 30}
  ...
  [:svg {:xmlns "http://www.w3.org/2000/svg" :width svg-width :height svg-height}
   [:g {:transform (translate marg marg)}
    ...
    (let [infotext (opentype/stack #_{:fill         "lightgray"
                     ...
                     {}
                     (flatten
                       [{:text "Feltmogning" :font "Roboto Black" :font-size 16}
                        (mapv (fn [k]
                                {:text      (str (subs k 3) "%")
                                 :font-size 16
                                 :font      "Roboto Bold"
...
(defn render-self []
  (core/render "./img/ncs-svg/petro-pp.svg" "./img/ncs-png/petro-pp.png" (diagram)))
