(ns clj-simple-chart.ncs.reserves.oil-reserves-share
  (:require [clj-simple-chart.ncs.johan-highlight-data :as datasource :refer [flat-data-liquids explode-row]]
...
(def header (opentype/stack
              ...
              [{:text "Andel av gjenverande oljereservar* over tid" :font "Roboto Bold" :font-size 30}
               {:text "Dei ti største oljefelta, Johan Castberg og alle andre felt" :font "Roboto Bold" :font-size 16}
               {:text          "Prosent" :font "Roboto Bold" :font-size 16
                :align         :right
                :margin-bottom 3
                :valign        :bottom}]))
...
(defn render-self []
  (core/render "./img/ncs-svg/remaining-reserves-oil-share.svg" "./img/ncs-png/remaining-reserves-oil-share.png" (diagram)))
