(ns clj-simple-chart.bp.diagrams.oil-production
...
(def data (->> bpdata/most-recent-data-countries
               ...
               (csv/keep-columns [:oil_production_kbd :country :country_code])
               (mapv #(assoc % :total (/ (:oil_production_kbd %) 1000.0)))
...
(def header (opentype/stack
              {}
              [{:text (str "Top " (count data) " Oil* Producers") :font "Roboto Black" :font-size 20}
...
(defn render-self []
  (render "./img/bp-svg/oil-production.svg" "./img/bp-png/oil-production.png" (diagram)))
