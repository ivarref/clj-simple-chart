(ns clj-simple-chart.bp.diagrams.germany.coaldiagram
...
(def header (opentype/stack
              ...
              [{:text "Germany: Coal consumption" :font "Roboto Bold" :font-size 28}
...
(defn render-self []
  (core/render "./img/bp-svg/germany-coal.svg" "./img/bp-png/germany-coal.png" (diagram)))